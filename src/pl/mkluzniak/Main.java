...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        frame.setLayout(new BorderLayout(10, 10));//add margins on panels
        frame.setVisible(true);

        JPanel panel1 = new JPanel(); //adding new panels
        JPanel panel2 = new JPanel();
        JPanel panel3 = new JPanel();
        JPanel panel4 = new JPanel();
        JPanel panel5 = new JPanel();

        panel1.setBackground(Color.red); //set color for panels
        ...
        panel1.setPreferredSize(new Dimension(100, 100)); //dimension for panels
        ...
        frame.add(panel1, BorderLayout.NORTH); //adding panels to frame window
